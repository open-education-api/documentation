...
These fields can be formatted to improve readability by using a subset of Markdown. OEAPI
...
To ensure optimal interoperability, Markdown-formatted text in OEAPI should not use:
...
CommonMark Markdown. By limiting the supported subset, OEAPI ensures predictable rendering
